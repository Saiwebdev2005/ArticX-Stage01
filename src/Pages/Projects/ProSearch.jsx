...
function ProSearch() {
 const [search,setSearch] = useState("");
  return (
      ...
      <form>
        ...
        <div className="relative">
          ...
          onChange={(e) => setSearch(e.target.value)}
            type="search"
            id="default-search"
            className="block w-full p-4 pl-10 text-sm text-black border border-gray-800 rounded-lg bg-purple-600 focus:ring-purple-500 focus:border-purple-500 placeholder:text-gray-900"
    ...
    return (
      <tr className="bg-black border border-purple-600" key={value.id}>
        <th
          scope="row"
