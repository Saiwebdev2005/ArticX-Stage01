...
function Offering() {
  return (
    <div className='container max-w-full bg-purple-600 p-32'>
  <Fade top distance="10%" duration={1500}>
    <div className='flex flex-col items-center justify-center max-w-6xl text-gray-900 space-y-6 space-x-24 font-OpenSans'>
      <div>
      ...
      <div className='flex flex-col md:flex-row max-w-4xl items-center justify-center space-x-0 md:space-x-6 space-y-6'>
        {/* card 1 */}
        <div className="card w-full md:w-96 h-96 bg-gray-900 shadow-xl mt-5 overflow-hidden text-purple-600">
        ...
        {/* card 2 */}
        <div className="card w-full md:w-96 h-96 bg-gray-900 shadow-xl overflow-hidden text-purple-600">
